...
public class Excel_Reader_Bhanu {
	public String path;
	FileInputStream fis;
	...
	public Excel_Reader_Bhanu(String path) {
		this.path = path;
		try {
	...
	public String getCellData(String sheetName, String colName, int rowNum) {
		try {
			...
			String cell = row.getCell(col_Num).toString();
	...
	public String getCellData(String sheetName, int colName, int rowNum) {
		try {
			...
			XSSFRow row = sheet.getRow(0);
			row = sheet.getRow(rowNum - 1);
			String cell = row.getCell(colName).toString();
	...
	public static void main(String[] args) {
		String path = System.getProperty("E:\\automation\\new.xlsx");
		Excel_Reader_Bhanu obj = new Excel_Reader_Bhanu(path);
